...
def yolo_head(feats, anchors, num_classes, input_shape, calc_loss=False):
    ...
    # feats_shape = K.print_tensor(K.shape(feats),message='Feat shape before:')
    # feats_ones = K.ones( feats_shape )
    # feats = feats * feats_ones
    feats = K.reshape(
        feats, [-1, grid_shape[0], grid_shape[1], num_anchors, num_classes + 5])
    # feats_shape = K.print_tensor(K.shape(feats),message='Feat shape after:')
    # feats_ones = K.ones( feats_shape )
    # feats = feats * feats_ones
...
def yolo_boxes_and_scores(feats, anchors, num_classes, input_shape, image_shape, batch_size=None):
...
def yolo_eval_batch(yolo_outputs,
    ...
    for l in range(num_layers):
        _boxes, _box_scores = yolo_boxes_and_scores(yolo_outputs[l],
            ...
            image_shape, batch_size=batch_size)
